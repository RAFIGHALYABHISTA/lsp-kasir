...
<?php $__env->startSection('subtitle', 'Riwayat dan log semua transaksi penjualan'); ?>
                ...
                <tr class="hover:bg-slate-50/80 transition-colors group">
                    <td class="px-6 py-4">
                        ...
                        <div class="text-xs text-slate-400">
                            <?php echo e($transaksi->transaksiDetails->count()); ?> item(s)
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class="font-medium text-slate-700">
                            <?php echo e($transaksi->tanggal_transaksi->format('d M Y')); ?>

                        </div>
                        <div class="text-xs text-slate-400">
                            <?php echo e($transaksi->tanggal_transaksi->format('H:i')); ?>
                    ...
                    <td class="px-6 py-4">
                        <div class="space-y-1">
                            ...
                            <div class="text-sm">
                                <span class="font-medium"><?php echo e($detail->barang->nama_barang); ?></span>
                                <span class="text-slate-400">(<?php echo e($detail->qty); ?> x Rp <?php echo e(number_format($detail->harga_barang, 0, ',', '.')); ?>)</span>
                            </div>
                    ...
                    <td class="px-6 py-4 text-center">
                        <div class="flex items-center justify-center gap-2">
                            <a href="<?php echo e(route('admin.kasir.invoice', $transaksi->id)); ?>"
                            ...
                            <form action="<?php echo e(route('admin.laporan.destroy', $transaksi->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus transaksi ini?')">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\gudang\resources\views/admin/laporan.blade.php ENDPATH**/ ?>