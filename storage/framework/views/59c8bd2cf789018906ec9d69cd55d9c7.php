...
<?php $__env->startSection('subtitle', 'Perbarui informasi customer'); ?>

<?php $__env->startSection('content'); ?>
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <form action="<?php echo e(route('admin.customers.update', $customer->id)); ?>" method="POST" class="p-8">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="Contoh: John Doe" value="<?php echo e(old('nama', $customer->nama)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="08123456789" value="<?php echo e(old('no_telepon', $customer->no_telepon)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                           placeholder="john@example.com" value="<?php echo e(old('email', $customer->email)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="Alamat lengkap customer"><?php echo e(old('alamat', $customer->alamat)); ?></textarea>
...
<?php echo $__env->make('layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\gudang\resources\views/admin/edit_customer.blade.php ENDPATH**/ ?>