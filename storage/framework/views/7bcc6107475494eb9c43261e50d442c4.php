...
<?php $__env->startSection('subtitle', 'Kelola kategori produk'); ?>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-1">
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            ...
            <form action="<?php echo e(route('admin.kategoris.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
                    <label for="nama_kategori" class="block text-sm font-semibold text-slate-700 mb-2">Nama Kategori</label>
                    <input type="text" name="nama_kategori" id="nama_kategori"
                           class="w-full px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none <?php $__errorArgs = ['nama_kategori'];
    ...
    <div class="lg:col-span-2">
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-100 bg-white">
                <h2 class="font-bold text-slate-800">Daftar Kategori (<?php echo e(count($kategoris)); ?>)</h2>
            </div>
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors group">
                            <td class="px-6 py-4">
                                <h4 class="font-semibold text-slate-800"><?php echo e($kat->nama_kategori); ?></h4>
                                <p class="text-xs text-slate-400 mt-1"><?php echo e($kat->deskripsi ?? '-'); ?></p>
                            </td>
                            <td class="px-6 py-4">
                                <span class="px-3 py-1 bg-blue-100 text-blue-700 text-sm font-semibold rounded-full">
                                    <?php echo e($kat->barangs->count()); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <button type="button" class="text-blue-600 hover:text-blue-700 text-sm" onclick="editKategori(<?php echo e($kat->id); ?>, '<?php echo e($kat->nama_kategori); ?>', '<?php echo e($kat->deskripsi); ?>')">
                                        <i class="fa-solid fa-edit"></i>
                                    </button>
                                    <form action="<?php echo e(route('admin.kategoris.destroy', $kat->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Yakin ingin menghapus kategori ini?')">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\gudang\resources\views/admin/kategoris.blade.php ENDPATH**/ ?>