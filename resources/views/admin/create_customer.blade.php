...
@section('subtitle', 'Masukkan detail informasi customer')

@section('content')
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        <form action="{{ route('admin.customers.store') }}" method="POST" class="p-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nama" id="nama"
                           ...
                           placeholder="Contoh: John Doe" value="{{ old('nama') }}" required>
                    @error('nama')
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="alamat" id="alamat" rows="3"
                              ...
                              placeholder="Alamat lengkap customer">{{ old('alamat') }}</textarea>
                    @error('alamat')
                        <p class="mt-2 text-xs text-red-600 font-medium">{{ $message }}</p>
                    @enderror
                </div>
