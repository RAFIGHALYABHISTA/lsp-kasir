...
@section('subtitle', 'Perbarui informasi barang inventaris')
...
@section('content')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="kode_barang" id="kode_barang"
                           ...
                           placeholder="Contoh: KPB001" value="{{ old('kode_barang', $barang->kode_barang) }}">
                    @error('kode_barang')
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nama_barang" id="nama_barang"
                           ...
                           placeholder="Contoh: Kopi Bubuk Arabika" value="{{ old('nama_barang', $barang->nama_barang) }}">
                    @error('nama_barang')
                        <p class="mt-2 text-xs text-red-600 font-medium">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="harga_barang" id="harga_barang"
                               ...
                               placeholder="0" value="{{ old('harga_barang', $barang->harga_barang) }}">
                    </div>
                    @error('harga_barang')
                        <p class="mt-2 text-xs text-red-600 font-medium">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    <label for="stok" class="block text-sm font-semibold text-slate-700 mb-2">Stok</label>
    ...
    @push('scripts')
    <script>
        document.getElementById('formEditBarang').addEventListener('submit', () => {
            Swal.fire({
                title: 'Memperbarui...',
                text: 'Mohon tunggu',
