...
<div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-6">
    ...
    <form action="{{ route('admin.laporan') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="flex items-end gap-2">
            ...
            <a href="{{ route('admin.laporan') }}" class="px-4 py-2 border border-slate-200 rounded-lg hover:bg-slate-50 font-semibold transition-all">
...
<div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
    <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-white">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('admin.laporan.export', ['month' => $month, 'year' => $year, 'search' => $search]) }}" class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold rounded-lg transition-all">
